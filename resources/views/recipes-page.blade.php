...
<body>
    ...
    <main class="main container-fluid p-0 overflow-hidden">
        <!--MAIN CONTAINER-->

        <header class="row d-flex justify-content between text-center px-3">
            <!--TOP BAR-->
        ...
        <section class="row d-flex justify-content-center p-5">
            <!--BODY CONTENT-->
            <article class="row bg-light">

                <div class="col-4"><!--RECIPE CARD-->
