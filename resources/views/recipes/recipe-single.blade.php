            ...
            <div class="row row-recipes pt-5 pb-5 d-flex justify-content-center">
                ...
                <div class="col-12 col-lg-9 p-4 col-recipe"><!--RECIPE START-->
                    ...
                    <div class="col-12 text-center">
                        ...
                        <p class="recipe-text-md d-block d-lg-inline"><span class="number">{{$recipe->time}}</span> Minutes</p>
                        <img class="recipe-icon-sm" src={{asset('images/icon-book.png')}} alt="book icon">
                        <p class="recipe-text-md d-block d-lg-inline"><span class="number"><?php echo str_word_count($recipe->ingredients); ?></span> Ingredients</p>
